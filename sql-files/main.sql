...
CREATE TABLE IF NOT EXISTS `bot_controller_demand_signal` (
  `controller_key` varchar(64) NOT NULL default '',
  `point_index` smallint(5) unsigned NOT NULL default '0',
  `signal_type` enum('merchant_open_map','merchant_live_map','merchant_stock_map','merchant_browse_map','merchant_sale_map','guild_enabled_name','guild_roster_name','guild_live_name','guild_storage_name','guild_storage_log_name','guild_castle_name','guild_candidate_map') NOT NULL default 'merchant_open_map',
...
VALUES
  ...
  ('social.prontera', 3, 'guild_storage_name', 'PBG150001', 1),
  ('social.prontera', 4, 'guild_storage_log_name', 'PBG150001', 1),
  ('social.prontera', 5, 'guild_castle_name', 'PBG150001', 2),
  ('patrol.prontera', 0, 'guild_candidate_map', 'prontera', 1),
  ('patrol.prontera', 1, 'guild_roster_name', 'PBG150001', 1),
  ('patrol.prontera', 2, 'guild_storage_name', 'PBG150001', 1),
  ('patrol.prontera', 3, 'guild_castle_name', 'PBG150001', 2),
