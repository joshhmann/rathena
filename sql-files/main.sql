...
--
-- Table structure for table `bot_shared_memory`
--
...
--
-- Table structure for table `bot_item_audit`
--
...
CREATE TABLE IF NOT EXISTS `bot_item_audit` (
  ...
  `action` enum('inventory_add','inventory_remove','equip','unequip','storage_deposit','storage_withdraw','consume','refine','reform','enchantgrade') NOT NULL default 'inventory_add',
  `item_id` int(10) unsigned NOT NULL default '0',
...
--
-- Table structure for table `bot_equipment_loadout`
--
...
--
-- Table structure for table `bot_recovery_audit`
--
...
CREATE TABLE IF NOT EXISTS `bot_trace_event` (
  ...
  `phase` enum('controller','scheduler','move','interaction','reservation','reconcile','combat') NOT NULL default 'controller',
